...
void skipWhiteSpace(parserS* parser){
...
char* readString(parserS* parser){
...
char* readNumber(parserS* parser){
...
char* readKeyword(parserS* parser){
...
char* readObject(parserS* parser){
